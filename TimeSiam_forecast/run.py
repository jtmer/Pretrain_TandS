...
# basic config
parser.add_argument('--pretrain_type', type=str, required=True, default='timesiam', help='pretrain_type, options:[timesiam, simmtm]')
parser.add_argument('--operation', type=str, required=True, default='pretrain', help='operation, options:[pretrain, train, fine_tune]')
parser.add_argument('--task', type=str, required=True, default='long_term_forecast', help='task, options:[long_term_forecast, classification]')
...
if args.operation == 'fine_tune':
    args.task_name = 'fine_tune'
elif args.operation == 'pretrain':
    args.task_name = args.pretrain_type
else:
    args.task_name = args.task

if args.operation == 'pretrain': 
    if args.pretrain_type == 'timesiam':
        Exp = Exp_Pretrain_TimeSiam
    elif args.pretrain_type == 'patchtst':
        Exp = Exp_Pretrain_PatchTST
    elif args.pretrain_type == 'simmtm':
